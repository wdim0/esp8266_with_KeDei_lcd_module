...
13.3 MHz CLK vs 20 MHz CLK comparison using WLCD demo:
1000 lines in 1833 ms vs 1595 ms => +15% faster
...
This hack would never be possible without the great starting point created by saper-2:
